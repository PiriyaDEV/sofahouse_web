...
CREATE TABLE IF NOT EXISTS musics(
  ...
  pri_lyrics_song   INT             NOT NULL,
  pri_music_prod    INT             NOT NULL,
  pri_vocal_rec     INT             NOT NULL,
  pri_music_score   INT             NOT NULL,
  pri_mix_master    INT             NOT NULL,
  pri_homepage      INT             NOT NULL,
  status            BOOLEAN         NOT NULL,
  created_at        BIGINT          NOT NULL,
  updated_at        BIGINT          NOT NULL,
  PRIMARY KEY (id)
